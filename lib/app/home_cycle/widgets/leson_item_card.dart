                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        title,
                        maxLines: 1,
                        style: TextManager.bold(fontSize: 20).copyWith(color: white),
                      ),
                      SizedBox(height: 5.h),
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("Class Duration: $duration min", style: regular),
                            Text(
                      ...
                      child: RichText(
                          ...
                          text: TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(
                                text: discountText!,
                                style: TextManager.medium(fontSize: 8.sp,).copyWith(
                                  color: white,
